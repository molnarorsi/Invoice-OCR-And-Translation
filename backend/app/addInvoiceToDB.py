...
def add_invoice(parsed_text, text, file_pdf, img_file, avg_score, rec_time, parse_time, ocr_method):
    ...
    invoice = Invoice(
        ...
        buyer_name=parsed_text.get('buyer_name'),
        buyer_address=parsed_text.get('buyer_address'),
        buyer_city=parsed_text.get('buyer_city'),
        buyer_TVA=parsed_text.get('buyer_TVA'),
        supplier_CIF=parsed_text.get('supplier_CIF'),
        supplier_name=parsed_text.get('supplier_name'),
        supplier_address=parsed_text.get('supplier_address'),
        supplier_city=parsed_text.get('supplier_city'),
        supplier_TVA=parsed_text.get('supplier_TVA'),
        text=text,
        avg_score=avg_score,
        rec_time=rec_time,
